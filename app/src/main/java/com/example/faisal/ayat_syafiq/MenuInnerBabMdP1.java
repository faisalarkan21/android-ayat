...
public class MenuInnerBabMdP1 extends AppCompatActivity implements BackPressedListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            startActivity(new Intent(MenuInnerBabMdP1.this,  MenuSubBab3.class));

            // Handle the camera action
        } else if (id == R.id.nav_info) {

            startActivity(new Intent(MenuInnerBabMdP1.this,  AboutActivity.class));
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MenuInnerBabMdP1.this);
